...
import { LastThreeMonthData } from '../utils/latestThreeMonthData'
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const threeMonthData = LastThreeMonthData(Object.values(monthlyRewardsData))
                setRewardsData(threeMonthData)
