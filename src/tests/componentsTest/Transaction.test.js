...
describe('TransactionDetails Component', () => {
  it('renders the table with transaction data', () => {
    ...
    expect(screen.getByRole('columnheader', { name: /Product Purchase/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /Price/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /Rewards Points/i })).toBeInTheDocument();
